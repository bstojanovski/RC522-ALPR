...
while continue_reading:
    ...
    if status == MIFAREReader.MI_OK:
        ...
        if saved:
            # Encode image file to base64 and send request to API
            IMAGE_PATH = 'kola.jpeg'
            SECRET_KEY = 'X' # GET YOUR OWN API KEY
            ...
            with open('apidata.json', 'w') as apidata:
                apidata.write(json.dumps(r.json()))
                apidata.close()
                
            cpdata_command = "cp apidata.json /var/www/html/api && cp kola.jpeg /var/www/html/api"
            ...
            with open('apidata.json', 'r') as infile:
                content = infile.read()
            ...
            print("ERROR: Unknown RFID detected!")
